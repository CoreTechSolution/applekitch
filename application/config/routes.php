...
$route['math-worksheet'] = 'frontend/math_worksheet';
$route['english-worksheet'] = 'frontend/english_worksheet';
$route['worksheet-favourite'] = 'frontend/worksheet_favourite';
$route['worksheet-recent'] = 'frontend/worksheet_recent';
