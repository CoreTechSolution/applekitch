                                            ...
                                            <div class="score_table">
                                                <div class="table_head">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-2"><div class="table_head_text">Questions</div></div>
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-4"><div class="table_head_text">Improvement</div></div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <?php foreach ($jquery_day_array as $key_cat=>$value_cat){ ?>
                                                        ...
                                                        <div class="panel">
                                                            <?php foreach($value_cat as $key_top=>$value_top) { ?>
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-2"><div class="table_body_text"><?php echo get_returnfield('topics','topic_id', $key_top,'topic_name'); ?></div></div>
                                                                    ...
                                                                    <div class="col-lg-2 col-md-2 col-sm-2 col-2"><div class="table_body_text"><?php echo (!empty($value_top['total_ans']))?$value_top['total_ans']:'0'; ?></div></div>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6"><div class="table_body_text">
