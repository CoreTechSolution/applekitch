        ...
        <?php if(!empty($work_categories) ) {?>
            ...
            <ul>
                ...
                <?php  foreach ($work_categories as $work_categorie) { ?>
                    <li><a id="search_click_c_<?= $work_categorie->id; ?>" href="<?= base_url('worksheets?type=cat&id='.$work_categorie->id); ?>"><?php echo $work_categorie->name; ?></a></li>
                <?php } ?>
            </ul>
        <?php } ?>
        ...
        <?php if(!empty($work_topics)){ ?>
            ...
            <ul>
                ...
                <?php  foreach ($work_topics as $work_topic) { ?>
                    ...
                    <li><a id="search_click_t_<?= $work_topic->id; ?>" href="<?= base_url('worksheets?type=topic&id='.$work_topic->id); ?>"><?php echo  $work_topic->name; ?></a></li>
