                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumbs">
                            ...
                            <li class="breadcrumbs__item"><a href="<?= base_url('worksheets'); ?>" class="breadcrumbs__element">Worksheets</a></li>
                            <?php if(!empty($this->uri->segment(1))) { ?>
                                <li class="breadcrumbs__item"><?php echo ucfirst($this->uri->segment(1)) ?></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
