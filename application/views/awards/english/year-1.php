        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="award_header">
                    <img src="<?php echo base_url('/assets/images/ela-level-b-display-case.png') ?>" />
                    <div class="reward reward_0" style="top: 67px; left: 267px;">
                        <h4>Questions answered</h4>
                        <div class="reward_img">
                            <img src="<?php echo base_url('/assets/images/award/reward_q.png') ?>" />
                        </div>
                    </div>
                    <div class="reward reward_1" style="top: 4px; left: 418px;">
                        <h4>Time spent</h4>
                        <div class="reward_img">
                            <img src="<?php echo base_url('/assets/images/award/reward_q.png') ?>" />
                        </div>
                    </div>
                    <div class="reward reward_2" style="top: 4px; left: 550px;">
                        <h4>Days practised</h4>
                        <div class="reward_img">
                            <img src="<?php echo base_url('/assets/images/award/reward_q.png') ?>" />
                        </div>
                    </div>
                    <div class="reward reward_3" style="top: 108px; left: 428px;">
                        <h4>Skills mastered</h4>
                        <div class="reward_img">
                            <img src="<?php echo base_url('/assets/images/award/reward_q.png') ?>" />
                        </div>
                    </div>
                    <div class="reward reward_4" style="top: 131px; left: 573px;">
                        <h4>Total SmartScore</h4>
                        <div class="reward_img">
                            <img src="<?php echo base_url('/assets/images/award/reward_q.png') ?>" />
                        </div>
                    </div>
                    <div class="reward reward_title" style="top: 70px; left: 712px; width: 128px;">
                        <h4></h4>
                    </div>
                    <div class="reward reward_practice" style="top: 243px; left: 721px;">
...
?>
<div class="award_stat" style="background-color: #ba6ecc;">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
