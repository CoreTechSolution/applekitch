                ...
                <div class="col-lg-3">
                    <div class="circleWrap"  style="background: <?= $colorcode[$rand] ?>; border: 3px solid <?= $colorcode[$rand] ?>; color: <?= $colorcode[$rand] ?>;">
                        ...
                        <div class="circleWrap-div">
                            <a href="<?php echo base_url('frontend/topic/'.$get_grade->slug.'/math'); ?>"><p>Maths<br><small><?php echo get_question_count('','math',$get_grade->slug); ?> Skills</small></p></a>
                            <a href="<?php echo base_url('frontend/topic/'.$get_grade->slug.'/english'); ?>"><p>English<br><small><?php echo get_question_count('','english',$get_grade->slug); ?> Skills</small></p></a>
                        </div>
                    </div>
                </div>
                <?php $rand++; ?>
