					...
					if(!empty($questions)) {
						...
						foreach($questions as $question) {
							...
							<tr>
								...
								<td><!--<a class="edit_link" href="<?php /*echo base_url('admin/edit_question/'.$question->question_id); */?>"><span data-feather="edit"></span> Edit</a> |--> <a class="delete_link" onclick="delete_data(<?php echo $question->question_id; ?>,'question_id','questions');" href="javascript:void(0)"><span data-feather="delete"></span> Delete</a></td>
							</tr>
							<?php
                            $counter++;
						}
