						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div style="text-align: right;">
									<a class="btn btn-sm btn-secondary" href="<?= base_url('/admin/question_option'); ?>">Question options</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-6">
								...
								<input required type="text" name="option_name" class="form-control" value=""/>
							</div>
