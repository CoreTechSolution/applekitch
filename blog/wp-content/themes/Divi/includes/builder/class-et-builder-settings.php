...
class ET_Builder_Settings {
	...
	protected static function _get_page_settings_values( $post_id ) {
		...
		/**
		 * Filters Cgs Builder page settings values.
		 *
		 * @since 3.0.45
		 *
		...
		/**
		 * Filters the Cgs Builder's page settings values.
		 *
	...
	protected function _initialize() {
		/**
		 * Filters Cgs Builder settings field definitions.
		 *
		 * @since 3.0.45
		 */
		...
		/**
		 * Filters Cgs Builder settings values.
		 *
		 * @since 3.0.45
		 *
		 * @param mixed[] $builder_settings {
		...
		/**
		 * Filters Cgs Builder page settings field definitions.
		 *
		 * @since 3.0.45
		 */
	...
	public static function add_epanel_tab( $tabs ) {
		$builder_tab = esc_html_x( 'Builder', 'Cgs Builder', 'et_builder' );
