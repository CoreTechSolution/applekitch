...
function et_fb_backend_helpers() {
	...
	$help_videos = array_merge( array(
		'et_pb_default' => array(
			array(
				...
				'name' => esc_html__( 'An introduction to the Cgs Builder', 'et_builder' ),
			),
			array(
			...
			array(
				...
				'name' => esc_html__( 'Importing and exporting Cgs Builder layouts', 'et_builder' ),
			),
			array(
	...
	$helpers['i18n'] = array(
		...
		'tooltips'            => array(
			...
			'exportText'       => esc_html__( 'Exporting your Cgs Builder Layout will create a JSON file that can be imported into a different website.', 'et_builder' ),
			'exportName'       => esc_html__( 'Export File Name', 'et_builder' ),
			'exportButton'     => esc_html__( 'Export Cgs Builder Layout', 'et_builder' ),
			'importText'       => esc_html__( 'Importing a previously-exported Cgs Builder Layout file will overwrite all content currently on this page.', 'et_builder' ),
			...
			'importButton'     => esc_html__( 'Import Cgs Builder Layout', 'et_builder' ),
		...
		'help' => array(
			'modal' => array(
				'title' 				=> esc_html__( 'Cgs Builder Helper', 'et_builder' ),
				'tabs'					=> array(
		...
		'unsavedConfirmation' => esc_html__( 'Unsaved changes will be lost if you leave the Cgs Builder at this time.', 'et_builder' ),
