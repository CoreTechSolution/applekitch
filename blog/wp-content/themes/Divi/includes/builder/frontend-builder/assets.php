...
function et_fb_enqueue_main_assets() {
	...
	// Enqueue styles if the Cgs Builder plugin is not active.
	...
	// Load Cgs Builder style.css file with hardcore CSS resets and Full Open Sans font if the Cgs Builder plugin is active
	if ( et_is_builder_plugin_active() ) {
		wp_enqueue_style(
