...
$epanelMainTabs = array('general','navigation','layout','ad','seo','integration');
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name"         => esc_html__( "Color Pickers Default Palette", $themename ),
				   ...
				   "desc"         => esc_html__( "Define the default color palette for color pickers in the Cgs Builder.", $themename ),
			),
